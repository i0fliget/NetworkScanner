...
function logNetworkScanning(data) {
  ...
  `;
    ...
    if (data.ip_threat_info['threat_lvl']) {
        if (data.ip_threat_info['threat_lvl'].toLowerCase().includes('high'))
            threat_class = 'threat-high';
        if (data.ip_threat_info['threat_lvl'].toLowerCase().includes('medium'))
...
function logBlacklistsVerification(data) {
    const container = document.getElementById('results-container');
    container.innerHTML = '';
...
function logAbuseScanning(data) {
    const container = document.getElementById('results-container');
    container.innerHTML = '';
